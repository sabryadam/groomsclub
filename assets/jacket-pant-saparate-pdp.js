  ...
  if (getCookie("fit-finder-data") != undefined || getCookie("fit-finder-data") != '') {
          ...
          if (result.data.length > 0) {
            ...
            if (result.data.length > 0) {
              ...
              if($(`.parent-product.product-type-jacket`).length > 0) {
                ...
                var option_thid = $(`.parent-product.product-type-jacket`).find(`.option-3`).text();
                ...
                $(`.parent-product.product-type-jacket`).find(`.edit-item-popup .single-option-selector option[data-title="${jacket_size} / ${jacket_type} / ${option_thid}"]`).prop("selected",true);
              }
              ...
              if($(`.parent-product.product-type-pants`).length > 0) {
                ...
                var option_thid = $(`.parent-product.product-type-pants`).find(`.option-3`).text();
                ...
                $(`.parent-product.product-type-pants`).find(`.edit-item-popup .single-option-selector option[data-title="${result.data[0].pants_waist} / ${result.data[0].pants_hight} / ${option_thid}"]`).prop("selected",true);
              }
            }
          }
        } else {
    ...
    if(check_fit_finder){
      ...
      if($(`.parent-product.product-type-pants`).length > 0) {
        ...
        $(`.parent-product.product-type-pants`).find(`.edit-item-popup .single-option-selector option[data-title="${getFitFinder.pants_waist} / ${getFitFinder.pants_hight} / ${option_thid}"]`).prop("selected",true);
      }
